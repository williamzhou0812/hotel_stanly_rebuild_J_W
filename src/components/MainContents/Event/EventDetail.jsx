    ...
    events = [
        {
            ...
            description:
                "In March, Port Moresby plays host to the SP Sports Awards which recognises the outstanding achievements of Papua New Guinea’s sporting elite. Fifteen awards are handed out on the night including the Male and Female Athlete of the Year. Facebook: spsportsawards",
            details: {
                call: "+675 302 8200",
                websit: null,
        ...
        },
        {
            ...
            month: "APRIL",
            description:
                "The Gogodala people from the Middle Fly District in the Western Province are renowned for their flamboyant and ornately crafted canoes. Once upon a time, it was customary for tribes to settle disputes by racing canoes which the festival pays homage to.",
            details: {
                call: null,
                website: null,
                email: null,
        ...
        },
        {
            ...
            month: "JUNE",
            description:
                "Showcasing cultural groups from the Madang Province, the Madang Festival celebrates the region’s rich culture with a colourful parade, live performances, canoe racing, sporting activities and stalls.",
            details: {
                call: "+675 422 3302",
        ...
        },
        {
            ...
            month: "JULY",
            description:
                "In July, the National Mask Festival in Rabaul brings the variety of the Papua New Guinean masks to one single celebration. The festival usually runs for four or five days and provides visitors with a fantastic array of performances including fire-eaters, singers, drummers, and more.",
            details: {
                call: "675 982 8697",
...

        {
            ...
            month: "AUGUST",
            description:
                "The Divine Word University Cultural Day is an annual event that sees students come together to perform and celebrate their cultural heritage.",
            details: {
                call: "+675 422 2937",
                website: "www.dwu.ac.pg",
                email: "events@dwu.ac.pg",
                location:
                    "Madang Campus, Divine Word University, Papua New Guniea"
            }
        },
        ...
        },
        {
            ...
            month: "AUGUST",
            description:
                "The Crocodile Festival is a three day event celebrating the local tribe’s cultural connection to the crocodile with the festival showcasing canoe racing and traditional performances.",
            details: {
                call: "+675 7259 6349",
                website: "www.papuanewguinea.travel",
        ...
        },
        {
            ...
            month: "SEPTEMBER",
            description:
                "Occurring in September, the Frangipani Festival celebrates Independence Day. See the famous Baining Fire Dance, sing-sings, a float parade and more.",
            details: {
                call: "+675 982 8697",
                website: "www.enb.travel",
                email: "www.engashow.com",
        ...
        },
        {
            ...
            month: "SEPTEMBER",
            description:
                "The Highlands region is famous for its primitive history, which included cannibalism and violent tribal wars. At the Goroka Show, descendants beat kundu drums and decorate themselves in unusual body paints and feathers to celebrate their unique heritage.",
            details: {
                call: "675 532 2644",
        ...
        },
        {
            ...
            month: "OCTOBER",
            description:
                "The Morobe Cultural Show is probably the most famous cultural show in PNG. It is held in October each year and provides visitors with agricultural information as well as showcases the largest group of sing-sings in PNG.",
            details: {
                call: "+675 472 2887",
        ...
        },
        {
            ...
            month: "NOVEMBER",
            description:
                "With its rich connection to the water, the people of Milne Bay celebrate a canoe festival in November each year. Visitors will see war canoes and locally-made kundu drums in all their glory.",
            details: {
                call: "+675 641 1503",
                website: null,
