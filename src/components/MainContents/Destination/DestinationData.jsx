...
export const destinations = [
    {
        ...
        mapImage: "/imgs/destination/_Maps/D1-Port-Moresby-Map-PORTMORESBY.png",
        CityMap: "/imgs/destination/_Maps/D1-PNG-Map-PORTMORESBY.png",
        url: destinationNamespace,
        province: "National Capital District",
        airport: "Port Moresby International Airport (Jacksons)",
        images: [         { imageFile: '/imgs/destination/D1-PortMoresby/D1_POM_IMAGES_P.jpg' },
        { imageFile: '/imgs/destination/D1-PortMoresby/D1_POM_IMAGES_P2.jpg' },
        { imageFile: '/imgs/destination/D1-PortMoresby/D1_POM_IMAGES_P3.jpg' }        ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D2-Lae-Map-LAE.png",
        CityMap: "/imgs/destination/_Maps/D2-PNG-Map-LAE.png",
        url: destinationNamespace,
        province: "Morobe",
        airport: "Nadzab Airport",
        images: [         { imageFile: '/imgs/destination/D2-Lae/D2-LAE-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D2-Lae/D2-LAE-IMAGES_P2.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D3-Madang-Map-MADANG.png",
        CityMap: "/imgs/destination/_Maps/D3-PNG-Map-MADANG.png",
        url: destinationNamespace,
        province: "Madang",
        airport: "Madang Airport",
        images: [         { imageFile: '/imgs/destination/D3-Madang/D3-MADANG-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D3-Madang/D3-MADANG-IMAGES_P2.jpg' } ,
        { imageFile: '/imgs/destination/D3-Madang/D3-MADANG-IMAGES_P3.jpg' }  ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D4-Mount-Hagen-Map-MOUNTHAGEN.png",
        CityMap: "/imgs/destination/_Maps/D4-PNG-Map-MOUNT-HAGEN.png",
        url: destinationNamespace,
        province: "Western Highlands",
        airport: "Kagamuga Airport",
        images: [         { imageFile: '/imgs/destination/D4-MountHagen/D4-MOUNTHAGEN-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D4-MountHagen/D4-MOUNTHAGEN-IMAGES_P2.jpg' } ],
        description:
    ...
    },
    {
        ...
        title: "KOKOPO",
        state: "PAPUA NEW GUNIEA",
        img_url: "/imgs/destination/D5-Kokopo/D5-KOKOPO-IMAGES_P2.jpg",
        mapImage: "/imgs/destination/_Maps/D5-Kokopo-Map-KOKOPO.png",
        CityMap: "/imgs/destination/_Maps/D5-PNG-Map-KOKOPO.png",
        url: destinationNamespace,
        province: "East New Britain",
        airport: "Tokua Airport",
        images: [         { imageFile: '/imgs/destination/D5-Kokopo/D5-KOKOPO-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D5-Kokopo/D5-KOKOPO-IMAGES_P2.jpg' }  ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D6-Goroka-Map-GOROKA.png",
        CityMap: "/imgs/destination/_Maps/D6-PNG-Map-GOROKA.png",
        url: destinationNamespace,
        province: "Eastern Highlands",
        airport: "Goroka Airport",
        images: [         { imageFile: '/imgs/destination/D6-Goroka/D6-GOROKA-IMAGE_P1.jpg' },
        { imageFile: '/imgs/destination/D6-Goroka/D6-GOROKA-IMAGE_P2.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D7-Alotau-Map-ALOTAU.png",
        CityMap: "/imgs/destination/_Maps/D7-PNG-Map-ALOTAU.png",
        url: destinationNamespace,
        province: "Milne Bay Province",
        airport: "Gurney Airport",
        images: [         { imageFile: '/imgs/destination/D7-Alotau/D7-ALOTAU-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D7-Alotau/D7-ALOTAU-IMAGES_P2.jpg' }  ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D8-Kimbe-Map-KIMBE-2.png",
        CityMap: "/imgs/destination/_Maps/D8-PNG-Map-KIMBE.png",
        url: destinationNamespace,
        province: "West New Britain",
        airport: "Hoskins Airport",
        images: [         { imageFile: '/imgs/destination/D8-Kimbe/D8-KIMBE-IMAGES_P1.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D9-Kavieng-Map-KAVIENG.png",
        CityMap: "/imgs/destination/_Maps/D9-PNG-Map-KAVIENG.png",
        url: destinationNamespace,
        province: "New Ireland Province",
        airport: "Kavieng Airport",
        images: [         { imageFile: '/imgs/destination/D9-Kavieng/D9-KAVIENG-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D9-Kavieng/D9-KAVIENG-IMAGES_P2.jpg' },
        { imageFile: '/imgs/destination/D9-Kavieng/D9-KAVIENG-IMAGES_P3.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D10-Wewak-Map-WEWAK.png",
        CityMap: "/imgs/destination/_Maps/D10-PNG-Map-WEWAK.png",
        url: destinationNamespace,
    ...
    },
    {
        ...
        title: "LORENGAU",
        state: "PAPUA NEW GUNIEA",
        img_url: "/imgs/destination/D11-Lorengau/D11-LORENGAU-IMAGES_P1.jpg",
        mapImage: "",
        CityMap: "/imgs/destination/_Maps/D11-PNG-Map-LORENGAU.png",
        url: destinationNamespace,
        province: "Manus Province",
        airport: "Momote Airport",
        images: [         { imageFile: '/imgs/destination/D11-Lorengau/D11-LORENGAU-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D11-Lorengau/D11-LORENGAU-IMAGES_P2.jpg' },
        { imageFile: '/imgs/destination/D11-Lorengau/D11-LORENGAU-IMAGES_P3.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "",
        CityMap: "/imgs/destination/_Maps/D12-PNG-Map-TUFI.png",
        url: destinationNamespace,
        province: "Oro Province",
        airport: "Girua Airport",
        images: [         { imageFile: '/imgs/destination/D12-Tufi/D12-TUFI-IMAGES_P1.jpg' },
        { imageFile: '/imgs/destination/D12-Tufi/D12-TUFI-IMAGES_P2.jpg' },
        { imageFile: '/imgs/destination/D12-Tufi/D12-TUFI-IMAGES_P3.jpg' } ],
        description:
    ...
    },
    {
        ...
        mapImage: "/imgs/destination/_Maps/D13-BUKA-Map-BUKA.png",
        CityMap: "/imgs/destination/_Maps/D13-PNG-Map-BUKA.png",
        url: destinationNamespace,
        province: "Autonomous Region of Bougainville",
        airport: "Buka Airport",
        images: [         { imageFile: '/imgs/destination/D13-Buka/D13-BUKA_P1.jpg' },
        { imageFile: '/imgs/destination/D13-Buka/D13-BUKA_P2.jpg' }  ],
        description:
